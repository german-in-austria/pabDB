...
# PABDB_DB_HOST="postgresql://localhost"					(Default: None)										#
# PABDB_DB_PORT="5433"										(Default: None)										#
#################################################################################################################
...
SECRET_KEY = '1234sdc7y_7plh(7xq2u-_ilgushpm*&^7&j0%6o-(3298askq1'
...
if 'PABDB_DB' in os.environ and os.environ['PABDB_DB']:
	...
	if 'PABDB_DB_NAME' in os.environ:
		DATABASES['default']['DBNAME'] = os.environ['PABDB_DB_NAME']
		DATABASES['default']['NAME'] = os.environ['PABDB_DB_NAME']
	if 'PABDB_DB_USER' in os.environ:
		DATABASES['default']['USER'] = os.environ['PABDB_DB_USER']
	if 'PABDB_DB_PASSWORD' in os.environ:
		DATABASES['default']['PASSWORD'] = os.environ['PABDB_DB_PASSWORD']
	if 'PABDB_DB_HOST' in os.environ:
		DATABASES['default']['HOST'] = os.environ['PABDB_DB_HOST']
	if 'PABDB_DB_PORT' in os.environ:
		DATABASES['default']['PORT'] = os.environ['PABDB_DB_PORT']
